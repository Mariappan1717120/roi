...
<head>
	...
	<title>Roi Design & Construction Panel</title>
...
<body>
	...
	<h3>Roi Design & Construction Panel</h3>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">      
      ...
      <ul class="nav navbar-nav navbar-right">        
        ...
        <li id="navProduct"><a href="product.php"> <i class="glyphicon glyphicon-ruble"></i> 2D Images </a></li>     
